...
export class initial1549480323140 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("CREATE TABLE `table_reports` (`id` varchar(255) NOT NULL, `name` varchar(255) NOT NULL, `startDateInMilliseconds` bigint NOT NULL, `endDateInMilliseconds` bigint NOT NULL, `period` int NOT NULL, `minMaxValues` json NULL, `userId` varchar(255) NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
